...
const UploadPage = () => {
  ...
  const handleImageUpload = async (event) => {
    ...
    try {
      ...
      if (response.status !== 200) {
        ...
        window.location.href = "#image-properties";
  ...
  const handleResetProperties = () => {
    const width = initialImageSize.width > canvasSize.width ? canvasSize.width : initialImageSize.width;
    const height = initialImageSize.height > canvasSize.height ? canvasSize.height : initialImageSize.height;
  ...
  return (
    <div className="container mt-2 mb-2">
      ...
      {imageURL && (
        <div className="card mt-4" id="image-properties">
          <div className="card-body">
